...
impl<H: DisplayAction> Envelope<H> {
    pub fn new(action_url: String, dest_url: String, head: H) -> Self {
        Envelope {
            action_url,
            dest_url,
            head,
    ...
    fn fmt<D: DisplayAction>(
        ...
        write!(fmt, r#"<?xml version="1.0" encoding="utf-8"?><soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Header>"#)?;
        self.head.fmt(fmt, &self.action_url)?;
        write!(
            fmt,
            r#"</soap:Header><soap:Body><{act} xmlns="{acturl}">"#,
            act = action,
